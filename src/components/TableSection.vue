...
onMounted(async () => {
  ...
  await axios
    ...
    .then(response => {
      cryptoPrice.value = response.data
      isLoading.value = false
      toast.success("Coin market fetched Successfully");
    }).catch(err => {
      isLoading.value = false
    ...
    <div class="table-container">
      ...
      <div class="price-tbl">
        <table id="price-table">
          ...
          <tbody v-else>
            <tr v-for="crypto in cryptoPrice.slice(10, 30)" :key="crypto.id">
              <td>
                <div class="tab">
                  <figure>
                    <img :src="crypto.image" alt="coin logo" class="crypt-img" />
                  </figure>
      ...
      <div class="mobi">
        <div
          class="mobi-con"
          v-for="crypto in cryptoPrice.slice(30, 40)"
          :key="crypto.id"
        >
          <div class="mobi-left">
            <figure>
